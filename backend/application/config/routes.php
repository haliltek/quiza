...
// Database backup
$route['backup/start_db'] = 'Backup/start_db';
$route['backup/process_db_chunk'] = 'Backup/process_db_chunk';
$route['backup/cancel_db'] = 'Backup/cancel_db';

// Asset backup (chunked)
$route['backup/start_assets'] = 'Backup/start_assets';
$route['backup/process_assets_chunked'] = 'Backup/process_assets_chunked';
$route['backup/cancel_assets'] = 'Backup/cancel_assets';
