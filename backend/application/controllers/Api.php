...
class Api extends REST_Controller
{
    public function __construct()
    {
        try {
            ...
            $this->systemTimezoneGMT = is_settings('system_timezone_gmt') ?? '+05:30';
            $this->systemTimezone = is_settings('system_timezone') ?? 'Asia/Kolkata';
            ...
            $optionShuffleMode = is_settings('option_shuffle_mode');;
            ...
            $response['error_msg'] = $sql->getMessage();
            ...
            if ($this->post('firebase_id') && $this->post('type') && ($this->post('firebase_id') != 'null') && ($this->post('firebase_id') != 'NULL')) {
                ...
                if ($is_verify) {
                    ...
                    if (!empty($res)) {
                        ...
                        $welcome_bonus_coins = (int)is_settings('welcome_bonus_coin') ?? 5;
        ...
        try {
            ...
            if ($user_status == 1) {
                if ($firebase_id) {
                    ...
                    $dailyAdsCoin = is_settings('daily_ads_coins');

                    // Get Daily Ads Counter from Settings
                    $dailyAdsCounter = is_settings('daily_ads_counter');
                ...
                if (!empty($data)) {
                    for ($i = 0; $i < count($data); $i++) {
                        ...
                        if ($user_id) {
                            ...
                            if ($type == 6 || $type == '6') {
                                $res = $this->db->where('category', $data[$i]['id'])->where('user_id', $user_id)->get('tbl_multi_match_level')->row_array();
                            } else {
                                $res = $this->db->where('category', $data[$i]['id'])->where('user_id', $user_id)->get('tbl_level')->row_array();
                            }
                ...
                if ($res) {
                    ...
                    if (!empty($data)) {
                        for ($i = 0; $i < count($data); $i++) {
                            ...
                            //check if category played or not
                            if ($type == 6 || $type == '6') {
                                $res = $this->db->where('subcategory', $data[$i]['id'])->where('category', $data[$i]['maincat_id'])->where('user_id', $user_id)->get('tbl_multi_match_level')->row_array();
                            } else {
                                $res = $this->db->where('subcategory', $data[$i]['id'])->where('category', $data[$i]['maincat_id'])->where('user_id', $user_id)->get('tbl_level')->row_array();
                            }
                            $data[$i]['is_play'] = (!empty($res)) ? '1' : '0';
                        }
                        $response['error'] = false;
        ...
        try {
            ...
            if ($this->post('level') && ($this->post('category') || $this->post('subcategory'))) {
                ...
                if ($fix_question == 1) {
                    ...
                    $limit = is_settings('quiz_zone_total_question');
                }
                $limit = ($this->post('limit') && is_numeric($this->post('limit'))) ? $this->post('limit') : $limit;
    ...
    public function get_questions_for_self_challenge_post()
    {
        try {
            ...
            if ($this->post('limit') && ($this->post('category') || $this->post('subcategory') || $this->post('category_slug') || $this->post('subcategory_slug'))) {
                ...
                $this->db->order_by($this->Order_By)->limit($limit, $offset);
                $data = $this->db->get('tbl_question')->result_array();
                if (!empty($data)) {
                    for ($i = 0; $i < count($data); $i++) {
                        $data[$i]['image'] = ($data[$i]['image']) ? base_url() . QUESTION_IMG_PATH . $data[$i]['image'] : '';
    ...
    public function get_questions_by_type_post()
    {
        try {
            ...
            if ($this->post('type')) {
                ...
                $offset = ($this->post('offset') && is_numeric($this->post('offset'))) ? $this->post('offset') : 0;
                $limit = ($this->post('limit') && is_numeric($this->post('limit'))) ? $this->post('limit') : is_settings('true_false_quiz_total_question');
    ...
    public function get_fun_n_learn_questions_post()
    {
        try {
            ...
            if ($this->post('fun_n_learn_id')) {
                ...
                $offset = ($this->post('offset') && is_numeric($this->post('offset'))) ? $this->post('offset') : 0;
                $limit = ($this->post('limit') && is_numeric($this->post('limit'))) ? $this->post('limit') : is_settings('fun_n_learn_quiz_total_question');
    ...
    public function get_guess_the_word_post()
    {
        try {
            ...
            if ($this->post('type') && $this->post('type_id')) {
                ...
                $offset = ($this->post('offset') && is_numeric($this->post('offset'))) ? $this->post('offset') : 0;
                $limit = ($this->post('limit') && is_numeric($this->post('limit'))) ? $this->post('limit') :  is_settings('guess_the_word_total_question');
    ...
    public function get_questions_post()
    {
        try {
            ...
            if ($this->post('type') && $this->post('id')) {
                ...
                $offset = ($this->post('offset') && is_numeric($this->post('offset'))) ? $this->post('offset') : 0;
                $limit = ($this->post('limit') && is_numeric($this->post('limit'))) ? $this->post('limit') : is_settings('quiz_zone_total_question');
    ...
    public function get_audio_questions_post()
    {
        try {
            ...
            if ($this->post('type') && $this->post('type_id')) {
                ...
                $offset = ($this->post('offset') && is_numeric($this->post('offset'))) ? $this->post('offset') : 0;
                $limit = ($this->post('limit') && is_numeric($this->post('limit'))) ? $this->post('limit') : is_settings('audio_quiz_total_question');
                        ...
                        if (!empty($user_res)) {
                            ...
                            if ($user_res['status'] == 1 || $user_res['status'] == '1') {
                                ...
                                if (!empty($payment_res)) {
                                    ...
                                    $hours_diff = is_settings('difference_hours') ?? 48;
    ...
    public function get_maths_questions_post()
    {
        try {
            ...
            if ($this->post('type') && $this->post('type_id')) {
                ...
                $offset = ($this->post('offset') && is_numeric($this->post('offset'))) ? $this->post('offset') : 0;
                $limit = ($this->post('limit') && is_numeric($this->post('limit'))) ? $this->post('limit') : is_settings('maths_quiz_total_question');
    ...
    public function update_daily_ads_counter_post()
    {
        ...
        try {
            ...
            $dailyAdsCoin = is_settings('daily_ads_coins') ?? 5;

            // Get Daily Ads Counter from Settings
            $dailyAdsCounter = is_settings('daily_ads_counter') ?? 1;
    ...
    public function get_multi_match_questions_post()
    {
        try {
            ...
            if ($this->post('type') && $this->post('id')) {
                ...
                $offset = ($this->post('offset') && is_numeric($this->post('offset'))) ? $this->post('offset') : 0;
                $limit = ($this->post('limit') && is_numeric($this->post('limit'))) ? $this->post('limit') : is_settings('multi_match_total_question');
        ...
        try {
            ...
            if ($this->post('level') && ($this->post('category') || $this->post('subcategory'))) {
                ...
                if ($fix_question == 1) {
                    ...
                    $limit = is_settings('multi_match_total_question');
                }
                $limit = ($this->post('limit') && is_numeric($this->post('limit'))) ? $this->post('limit') : $limit;
            ...
            $response['message'] = "122";
            $response['error_msg'] = $sql->getMessage();
            $response['error_msg1'] = print_r($sql);
        } catch (Exception $e) {
            $response['error'] = true;
            $response['message'] = "122";
            $response['error_msg'] = $e->getMessage();
    ...
    function QuizZone($user_id, $table, $category, $subcategory, $playQuestions,  $lifelineData = [])
    {
        ...
        if ($checkData) {
            ...
            $currentLevel = $setQuestions[0]['level'] ?? 0;
            $totalLevel = 0;
            if ($currentLevel == 0) {
                $setQuestionMap = [];
                ...
                if ($winningPer >= $quiz_winning_percentage) {
                    ...
                    if ($subcategory) {
                        $checkIsPlayed = $this->db->where('user_id', $user_id)->where('subcategory', $subcategory)->where('category', $category)->order_by('id', 'desc')->get('tbl_level')->row_array();
                    } else {
                        $checkIsPlayed = $this->db->where('user_id', $user_id)->where('category', $category)->order_by('id', 'desc')->get('tbl_level')->row_array();
                    }

                    $isPlayed = !empty($checkIsPlayed) ? 1 : 0;
                ...
                if ($currentLevel <= $totalLevel) {
                    ...
                    if ($winningPer >= $quiz_winning_percentage) {
                        ...
                        $userScore = ($correctAnswer * $quiz_zone_correct_answer_credit_score) - ($wrongAnswer * $quiz_zone_wrong_answer_deduct_score);
                        $getLevelData = $this->db->select('level')->where('user_id', $user_id)->where('category', $category)->where('subcategory', $subcategory)->order_by('id', 'desc')->get('tbl_level')->row_array();
    ...
    function multiMatch($user_id, $table, $category, $subcategory, $playQuestions)
    {
        ...
        if ($checkData) {
            $setQuestions = json_decode($checkData['questions'], true);
            $currentLevel = $setQuestions[0]['level'] ?? 0;
            $earnCoin = $userScore = $totalLevel = 0;
            if ($currentLevel == 0) {
                $setQuestionMap = [];
                $setQuestionMap = array_column($setQuestions, 'answer', 'id');
                $total_questions = count($setQuestions);
                ...
                if ($winningPer >= $quiz_winning_percentage) {
                    ...
                    if ($subcategory) {
                        $checkIsPlayed = $this->db->where('user_id', $user_id)->where('subcategory', $subcategory)->where('category', $category)->order_by('id', 'desc')->get('tbl_multi_match_level')->row_array();
                    } else {
                        $checkIsPlayed = $this->db->where('user_id', $user_id)->where('category', $category)->order_by('id', 'desc')->get('tbl_multi_match_level')->row_array();
                    }
                ...
                if ($currentLevel <= $totalLevel) {
                    ...
                    if ($winningPer >= $quiz_winning_percentage) {
                        ...
                        $userScore = ($correctAnswer * $multi_match_correct_answer_credit_score) - ($wrongAnswer * $multi_match_wrong_answer_deduct_score);
                        $getLevelData = $this->db->select('level')->where('user_id', $user_id)->where('category', $category)->where('subcategory', $subcategory)->order_by('id', 'desc')->get('tbl_multi_match_level')->row_array();
