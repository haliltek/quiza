...
<body>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-4 col-lg-4 col-sm-12 col-12">
                                                    ...
                                                    <select name="ai_provider" id="ai_provider" class="form-control" required>
                                                        ...
                                                        <option value="openrouter" <?= (($ai_provider['message'] ?? '') == 'openrouter') ? 'selected' : '' ?>><?= lang('openrouter') ?? 'OpenRouter' ?></option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group col-md-4 col-lg-4 col-sm-12 col-12 openrouterData">
                                                    <label class="control-label"><?= lang('ai_api_key'); ?> <small class="text-muted">(sk-or-v1-...)</small></label><br>
                                                    <div class="input-group">
                                                        <input type="password" id="openrouter_api_key" name="openrouter_api_key" class="form-control" placeholder="sk-or-v1-..." value="<?= $openrouter_api_key['message'] ?? '' ?>">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text">
                                                                <i class="fa fa-eye-slash" id="btnOpenrouterIcon"></i>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <small class="form-text text-muted">
                                                        <a href="https://openrouter.ai/keys" target="_blank" rel="noopener noreferrer"><i class="fas fa-key"></i> Get API Key</a> &nbsp;|&nbsp;
                                                        <a href="https://openrouter.ai/models" target="_blank" rel="noopener noreferrer"><i class="fas fa-list"></i> Browse Models</a>
                                                    </small>
                                                </div>
                                            </div>
                                            <div class="row">
    ...
    <script>
        ...
        function providerData(ai_provider) {
            $('.geminiData, .openaiData, .openrouterData').hide();
            $('#gemini_model, #gemini_api_key, #openai_model, #openai_api_key, #openrouter_model, #openrouter_api_key').removeAttr('required');
            ...
            if (ai_provider == 'gemini') {
                ...
                $('.openrouterData').show();
                $('#openrouter_model').attr('required', true);
                $('#openrouter_api_key').attr('required', true);
            }
        }
        ...
        toggleApiKeyVisibility("#btnOpenrouterIcon", "#openrouter_api_key");
    </script>
</body>
