...
final class BattleRoomRemoteDataSource {
    ...
    try {
      ...
      if (responseJson['error'] as bool) {
        ...
        await CrashlyticsUtils.logApiException(
          endpoint: getQuestionForOneToOneBattle,
  ...
  Future<List<Map<String, dynamic>>?> getMultiUserBattleQuestions(
    ...
    Map<String, dynamic>? requestBody;
    try {
      requestBody = <String, String?>{roomIdKey: roomCode};
      ...
      if (responseJson['error'] as bool) {
        ...
        await CrashlyticsUtils.logApiException(
          endpoint: getQuestionForMultiUserBattle,
          errorMessage: errorMessage,
          requestParams: requestBody,
          responseBody: response.body,
          statusCode: response.statusCode,
  ...
  Future<DocumentSnapshot> createMultiUserBattleRoom({
    ...
    try {
      ...
      if (responseJson['error'] as bool) {
        final errorMessage = responseJson['message'].toString();
        await CrashlyticsUtils.logApiException(
          endpoint: createMultiUserBattleRoomUrl,
          errorMessage: errorMessage,
          requestParams: requestBody,
          responseBody: response.body,
          statusCode: response.statusCode,
