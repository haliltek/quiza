...
class _CreateOrJoinRoomScreenState extends State<CreateOrJoinRoomScreen> {
  ...
  void showJoinRoomBottomSheet() {
    ...
    final joinRoomPinController = PinInputController(textController: joinRoomCode);
              ...
              children: [
                ...
                Padding(
                  ...
                  child: MaterialPinField(
                    length: 6,
                    pinController: joinRoomPinController,
                    keyboardType:
                    ...
                    theme: MaterialPinTheme(
                      ...
                      fillColor: colorScheme.onTertiary.withValues(alpha: 0.1),
                      focusedFillColor: colorScheme.onTertiary.withValues(
                        alpha: 0.1,
                      ),
                      filledFillColor: colorScheme.onTertiary.withValues(
                        alpha: 0.2,
                      ),
                      borderColor: colorScheme.onTertiary.withValues(
                        alpha: 0.1,
                      ),
                      filledBorderColor: colorScheme.onTertiary.withValues(
                        alpha: 0.1,
                      ),
