...
class _QuizScreenState extends State<QuizScreen> with TickerProviderStateMixin {
  late final int quizDuration;
  late final PreserveAnimationController timerAnimationController;
  ...
  void initState() {
    ...
    // Initialize quiz duration from SystemConfigCubit
    quizDuration = context.read<SystemConfigCubit>().quizTimer(
      widget.quizType,
    );

    // Initialize timer animation controller
    timerAnimationController = PreserveAnimationController(
