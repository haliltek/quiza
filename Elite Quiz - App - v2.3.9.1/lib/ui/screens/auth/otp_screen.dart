...
class _OtpScreen extends State<OtpScreen> {
  ...
  late final pinController = PinInputController(textController: smsCodeController);
  ...
  Widget _buildSmsCodeContainer() {
    ...
    return MaterialPinField(
      ...
      theme: MaterialPinTheme(
        ...
        focusedFillColor: Theme.of(context).primaryColor,
        filledFillColor: colorScheme.surface,
        borderColor: colorScheme.surface,
        focusedBorderColor: Theme.of(context).primaryColor.withValues(alpha: 0.5),
        filledBorderColor: colorScheme.surface,
