...
class _ExamKeyBottomSheetContainerState
  ...
  late final examKeyPinController = PinInputController(
    textController: examKeyController,
  );
  ...
  void initState() {
    super.initState();
    if (widget.exam.examKey.isNotEmpty) {
      examKeyController.text = widget.exam.examKey;
    }
  }
                ...
                Align(
                  child: Padding(
                    ...
                    child: MaterialPinField(
                      pinController: examKeyPinController,
                      length: 4,
                      hintCharacter: '-',
                      ...
                      theme: MaterialPinTheme(
                        ...
                        fillColor: _onTertiary.withValues(alpha: 0.1),
                        focusedFillColor: _onTertiary.withValues(alpha: 0.1),
                        filledFillColor: _onTertiary.withValues(alpha: 0.2),
                        borderColor: _onTertiary.withValues(alpha: 0.1),
                        filledBorderColor: _onTertiary.withValues(alpha: 0.1),
                  ...
                  child: errorMessage.isEmpty
                      ...
                      : Padding(
                          ...
                          child: SizedBox(
                            ...
                            child: Text(
                              errorMessage,
                              style: const TextStyle(color: kHurryUpTimerColor),
                            ),
                          ),
                        ),
                ),
