      ...
      builder: (context, state) {
        ...
        return ListView.builder(
          ...
          padding: EdgeInsets.only(
            top: context.width * UiUtils.vtMarginPct,
            bottom: context.width * UiUtils.vtMarginPct + 70,
    ...
    return BlocConsumer<ExamsCubit, ExamsState>(
      ...
      builder: (context, state) {
        ...
        final exams = (state as ExamsFetchSuccess).exams
          ..removeWhere((exam) => (int.tryParse(exam.noOfQue) ?? 0) == 0);
        ...
        return ListView.separated(
          padding: EdgeInsets.only(
            ...
            bottom: context.height * UiUtils.vtMarginPct + 70,
            left: context.width * UiUtils.hzMarginPct,
            right: context.width * UiUtils.hzMarginPct,
          ),
