...
- <span className="badge badge--info">Improved</span> Made level selection optional in Quiz Zone and MultiMatch within category and subcategory flows.
...
- <span className="badge badge--info">Improved</span> Wallet page clarity by clearly defining the conversion rate between coins and currency.
...
- <span className="badge badge--danger">Fixed</span> Wallet payout issues to ensure accurate and reliable transactions.
...
- <span className="badge badge--danger">Fixed</span> Refactored core logic to enhance error handling and overall code stability.
- <span className="badge badge--info">Improved</span> Codebase improvements for better maintainability, performance, and consistent error management.
</ul>
</details>
